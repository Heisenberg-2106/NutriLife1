...
export default function DietRecommendationPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-theme">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-neon-blue mb-2 animate-glow">
              AI-Powered Diet Recommendations
            </h1>
            <p className="text-lg text-white/80">
              Get personalized meal plans based on your unique profile and health needs
            </p>
          </div>
          
          {/* Top Grid - How It Works and Form */}
              ...
              <CardContent>
                <ul className="space-y-4 text-white/90">
                  <li className="flex items-start">
                    ...
                    <span>Enter your basic health information</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-neon-purple mr-2">•</span>
                    <span>Specify your dietary preferences</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-neon-purple mr-2">•</span>
                    <span>Our AI analyzes your profile</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-neon-purple mr-2">•</span>
                    <span>Receive a customized nutrition plan</span>
                  </li>
                </ul>
                <div className="mt-8 p-4 bg-white/5 rounded-lg border border-neon-blue/20">
                  <h3 className="text-lg font-medium text-neon-blue mb-2">
                    Pro Tip
                  </h3>
                  <p className="text-white/80">
                    For best results, provide accurate information about your activity level and health conditions.
                  </p>
                </div>
              </CardContent>
            </Card>
            
            {/* Form Card - Using your working form implementation */}
            <Card className="bg-gray-800/50 backdrop-blur-sm border-gray-700 shadow-xl">
          ...
          {/* Full-width Results Card Below - Using your working results implementation */}
          {dietInfo && (
